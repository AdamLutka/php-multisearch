...
if test "$PHP_MULTISEARCH" != "no"; then
	...
	PHP_NEW_EXTENSION(multisearch, src/multisearch.cpp src/extension_api/common.cpp src/extension_api/needles_bundle_loader.cpp src/extension_api/needles_bundle_loader_interface.cpp src/extension_api/needles_bundle_storage_interface.cpp src/extension_api/memory_persistent_storage.cpp src/extension_api/multisearch_exception.cpp src/extension_api/needle.cpp src/extension_api/needles_bundle.cpp src/extension_api/search_hit.cpp src/storage/trie_file_loader.cpp src/storage/trie_repository.cpp, $ext_shared)
fi
